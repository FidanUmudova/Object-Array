...
//   if (array[i].id === myId) {
//     country = array[i].shipAddress.country; 
//     break; 
//   }
// }
// console.log(myId + ": " + country);
...
// for (let i=0; i<array.length; i++) {
//     if (array[i].shipAddress.country === "Germany") {
//       console.log(array[i]);
//     }
// }
...
// for (let i = 0; i < array.length; i++) {
//     if (array[i].id === myyId) {
//       shipName = array[i].shipName;
//       country = array[i].shipAddress.country;
//       city = array[i].shipAddress.city;
//       break;
//     }
// }
// console.log(shipName , country , city);  
...
// let cem = 0;
// for (let i = 0; i < array.length; i++) {
//   if (array[i].id === myyyId) {
//     cem = array[i].details.length; 
//     break;
//   }
// }
// console.log(cem);
...
// let cemm=0;
// for (let i =0; i < array.length ; i++) {
//     const newArray = array[i].details;
// }
// for (let i = 0; i < array.length; i++) {
//     if (array[i].id === myyyyId) {
//         cemm += array[i].details.productId; 
//         cemm += array[i].details.unitPrice; 
//         cemm += array[i].details.quantity; 
//         cemm += array[i].details.discount; 
//         break;
//     }
